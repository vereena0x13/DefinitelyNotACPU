...
#define SR_PC_INC               (1llu << 13llu)                         // PC           :=  PC + 1
...
#define SR_UPC_RST              (1llu << 22llu)                         // μPC          :=  0
#define SR_RAM_RD               (1llu << 23llu)                         // ram[addr]    ->  data
#define SR_RAM_WR               (1llu << 24llu)                         // ram[addr]    :=  data
#define SR_IR_LD                (1llu << 25llu)                         // IR           :=  data
#define SR_ADDR_LO_TO_D         (1llu << 26llu)                         // addr[:7]     ->  data
#define SR_ADDR_HI_TO_D         (1llu << 27llu)                         // addr[8:]     ->  data
#define SR_D_TO_MAR_LO          (1llu << 29llu)                         // data         ->  MAR[:7]
#define SR_D_TO_MAR_HI          (1llu << 28llu)                         // data         ->  MAR[8:]
#define SR_UPC_INC              (1llu << 30llu)                         // μPC          :=  μPC + 1
#define SR_ALU_RD               (1llu << 31llu)                         //
